...
## Taro 系列（taro-webpack-tailwindcss-v3 / taro-webpack-tailwindcss-v4）
- **核心实现**：`demo/taro-webpack-tailwindcss-v3/node_modules/@tarojs/webpack5-runner/dist/webpack/MiniWebpackModule.js`
...
## Mpx 系列（mpx-tailwindcss-v3 / mpx-tailwindcss-v4）
- **基础栈**：继承 Vue CLI（`demo/mpx-tailwindcss-v3/node_modules/@vue/cli-service/lib/config/css.js:99-194`）
  - 默认顺序：`MiniCssExtractPlugin.loader`（或 `vue-style-loader`）`→ css-loader → (cssnano 可选) → postcss-loader → 预处理器`。
- **Mpx 注入**：`demo/mpx-tailwindcss-v3/node_modules/@mpxjs/webpack-plugin/lib/index.js:1883-2042`
...
## 说明
- `uni-app-vite-tailwindcss-v4` / `taro-vite-tailwindcss-v3` 等 Vite 工程不在本文范围。
