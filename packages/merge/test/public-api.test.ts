...
it('has correct export types', () => {
  ...
  const noRun = () => {
    ...
    const classValidator: ClassValidator = (_value: string) => false
...
it('twMerge() has correct inputs and outputs', () => {
...
it('createTailwindMerge() has correct inputs and outputs', () => {
...
it('validators have correct inputs and outputs', () => {
...
it('mergeConfigs has correct inputs and outputs', () => {
  expect(
    mergeConfigs(
      {
        cacheSize: 50,
...
it('extendTailwindMerge has correct inputs and outputs', () => {
  expect(extendTailwindMerge({} satisfies ConfigExtension<string, string>)).toStrictEqual(
    expect.any(Function),
  )
})

it('fromTheme has correct inputs and outputs', () => {
...
it('twJoin has correct inputs and outputs', () => {
