import type { AnyConfig } from '../src/lib/types'

import { expect, it } from 'vitest'
import { extendTailwindMerge, fromTheme, getDefaultConfig, mergeConfigs } from '../src'

it('extendTailwindMerge type generics work correctly', () => {
...
it('fromTheme type generics work correctly', () => {
...
it('mergeConfigs type generics work correctly', () => {
