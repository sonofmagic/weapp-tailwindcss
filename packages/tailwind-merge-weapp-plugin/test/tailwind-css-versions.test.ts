...
import { cn, replaceJs, twMergeReplaceJs as twMerge } from './utils'
...
it.skip('supports Tailwind CSS v3.3 features', () => {
  expect(cn('text-red text-lg/7 text-lg/8')).toEqual('text-red text-lg/8')
...
it('supports Tailwind CSS v3.4 features', () => {
