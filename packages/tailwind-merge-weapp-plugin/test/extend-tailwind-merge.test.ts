...
import { extendTailwindMerge } from './utils'

it('extendTailwindMerge works correctly with single config', () => {
...
it('extendTailwindMerge works corectly with multiple configs', () => {
  const tailwindMerge = extendTailwindMerge<string>(
    {
      cacheSize: 20,
      extend: {
...
it('extendTailwindMerge works correctly with function config', () => {
...
it('extendTailwindMerge overrides and extends correctly', () => {
  const tailwindMerge = extendTailwindMerge<string>({
    cacheSize: 20,
    override: {
      classGroups: {
