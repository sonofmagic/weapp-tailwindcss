...
从[安装指南](https://tw.icebreaker.top/docs/quick-start/install)开始，或在[官网](https://tw.icebreaker.top)按框架选择接入方式。
...
source map、stdin/stdout、watch 与 `canonicalize` 的完整用法见 [CLI 指南](https://tw.icebreaker.top/docs/tools/weapp-tw-cli)。
...
- [技术交流群](https://tw.icebreaker.top/docs/community/group)
