...
describe('taro preset', () => {
  ...
  it('sets taro defaults and resolves cwd', () => {
    env.clearBaseEnv()
    process.env.PWD = '/Users/foo/taro-webpack-tailwindcss-v3'
    process.env.INIT_CWD = '/Users/foo/taro-webpack-tailwindcss-v3'
    const result = taro({
      base: '.',
    ...
    expect(result.tailwindcssBasedir).toBe(path.resolve('/Users/foo/taro-webpack-tailwindcss-v3', '.'))
