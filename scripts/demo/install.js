...
const version = isAlpha ? '@alpha' : isBeta ? '@beta' : isRc ? '@rc' : ''
  ...
  await run(
    ...
    } tailwindcss-rem2px-preset@latest @weapp-tailwindcss/merge${version} postcss-rem-to-responsive-pixel@latest weapp-ide-cli@latest postcss-rpx-transform weapp-tailwindcss-children tailwind-css-variables-theme-generator tailwindcss@latest --ignore-engines`,
  )
