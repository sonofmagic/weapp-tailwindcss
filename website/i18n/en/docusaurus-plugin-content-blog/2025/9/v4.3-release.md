...
See the [current source and option types](https://github.com/sonofmagic/weapp-tailwindcss/tree/main/packages/weapp-tailwindcss/src) for the latest API shape.
