...
Known local selector overrides, conditional rules, or conflicting sources in a shared output prevent static evaluation of affected variables and their dependencies. Independent outputs keep separate contexts, and incremental generation recalculates after theme or configuration changes. Unresolved or unselected variables and their `var()` fallbacks retain runtime semantics.
