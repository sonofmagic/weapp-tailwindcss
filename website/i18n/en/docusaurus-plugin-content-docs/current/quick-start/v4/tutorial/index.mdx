...
description: >-
  Tailwind CSS 4 moves the configuration entry to CSS: theme variables and custom tools can be declared using native
  syntax. weapp-tailwindcss has adapted to this compilation process. This article takes 30 minutes to build a tailwi...
keywords:
  - quick start
  - Install
  - Configuration
