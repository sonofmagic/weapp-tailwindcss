...
Use the [verified uni-app x + Tailwind CSS 4 demo](https://github.com/sonofmagic/weapp-tailwindcss/tree/next/demo/uni-app-x-vdom-tailwindcss-v4) and follow its README. Do not use the old `icebreaker-template/uni-app-x-hbuilderx` as the starting point for a new project.
...
- [Tailwind CSS 4 demo in the repository](https://github.com/sonofmagic/weapp-tailwindcss/tree/next/demo/uni-app-x-vdom-tailwindcss-v4)
