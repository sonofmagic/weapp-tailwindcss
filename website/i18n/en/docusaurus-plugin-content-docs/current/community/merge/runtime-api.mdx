...
If the project must continue to use Tailwind CSS v3, please install `weapp-tailwindcss@4` and check out the [v4 documentation site](https://v4.tw.icebreaker.top/); `@weapp-tailwindcss/runtime` is usually installed automatically as an indirect dependency.
