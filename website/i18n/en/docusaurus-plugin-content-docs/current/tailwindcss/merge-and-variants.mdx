...
<TailwindTopicHero topicId="tailwindcss/merge-and-variants" title="tailwind-merge、cva、tailwind-variants Essentials" />
...
```html
<!-- expect p-2 cover p-4，but generated CSS The order is still p-2 in front、p-4 behind -->
