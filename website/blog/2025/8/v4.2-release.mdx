...
这篇发布日志中的旧接入示例已经迁移。当前站点只保留 Tailwind CSS 4 接入说明。
...
当前接入方式已经合并到 [快速使用](https://tw.weapp.dev/docs/quick-start/install)。不再需要配置 `postinstall: "weapp-tw patch"`。
...
当前 Tailwind CSS 4 配置请查看 [uni-app x 接入文档](/docs/quick-start/frameworks/uni-app-x)。
...
[weapp-tailwindcss 官网](https://tw.weapp.dev/)

[weapp-tailwindcss 的 uni-app x 接入页](https://tw.weapp.dev/docs/quick-start/frameworks/uni-app-x)
