...
export const homepageUiControls: HomepageUiControlMeta[] = [
  ...
  },
  {
    key: 'heroFeatureGrid',
    label: '核心能力区',
    description: '控制首页核心能力与构建链路说明区域整体显示。',
  ...
  },
  {
    key: 'heroBadge',
    label: 'Hero 顶部标签',
    description: '控制 logo 右侧的 v5 与 Tailwind CSS 4 website mode 标签。',
  ...
  },
  {
    ...
    label: 'Hero 副标题二',
    description: '保留旧版副文案开关，用于兼容 UI 管理配置。',
  ...
  },
  {
    key: 'communityEntry',
    label: '技术交流群入口',
    description: '控制首页文档入口区域的技术交流群入口。',
  ...
  },
  {
    ...
    description: '控制支持矩阵区域的 GitHub Star 徽章。',
  ...
  },
  {
    key: 'npmVersionBadge',
    label: 'npm 版本徽章',
    description: '控制支持矩阵区域的 npm 最新版本徽章。',
