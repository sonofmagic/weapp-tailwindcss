...
- **postcss-modules**：以插件形式实现 CSS Modules 规范，生成哈希类名与映射文件，是 [CSS Modules / Scoped 阶段](/tailwindcss/history/css-modules) 的构建期实现之一；当你在 webpack/Vite 开启 `modules` 时，底层也是类似逻辑。
