...
title: v5 Tailwind CSS v4 生成器示例
description: 使用 weapp-tailwindcss v5 生成器接入 uni-app Vue Vite、Taro Vite 与 Mpx 的完整示例
sidebar_position: 6
keywords:
  - weapp-tailwindcss
  - tailwindcss v4
...
仓库示例：`demo/uni-app-tailwindcss-v4`。
...
验证命令：`pnpm --filter @weapp-tailwindcss-demo/uni-app-tailwindcss-v4 build`

## Taro Vite

仓库示例：`demo/taro-vite-tailwindcss-v4`。
...
验证命令：`pnpm --filter @weapp-tailwindcss-demo/taro-vite-tailwindcss-v4 build`

## Mpx

仓库示例：`demo/mpx-tailwindcss-v4`。
...
验证命令：`pnpm --filter @weapp-tailwindcss-demo/mpx-tailwindcss-v4 build`
...
pnpm --filter @weapp-tailwindcss-demo/mpx-tailwindcss-v4 build
pnpm build:apps
pnpm build:demo
```
