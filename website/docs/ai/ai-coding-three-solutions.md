...
- **试用限制**：试用版固定限额 500 credits/月，不可超量

> **注意**：官网显示试用额度为 50 credits，实际发放为 **500 credits/月**（可能是官方文档错误）。
...
| ------------------ | ------------------ | ----------------- | ------------------ | -------- |
| **AWS Kiro**       | 试用 500 积分/月   | $20/月 (Pro)      | $200/月 (Power)    | 月度重置 |
