...
如果项目必须继续使用 Tailwind CSS v3，请安装 `weapp-tailwindcss@4` 并查看 [v4 文档站](https://v4.tw.icebreaker.top/)；而 `@weapp-tailwindcss/runtime` 通常作为间接依赖被自动安装。
...
`@weapp-tailwindcss/merge` 默认使用 `createRpxLengthTransform()` 作为预处理/还原钩子。
...
- Tailwind CSS 3 项目：请使用 `weapp-tailwindcss@4` 并查看 [v4 文档站](https://v4.tw.icebreaker.top/)
