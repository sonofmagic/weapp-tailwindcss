...
export const webViteHmrCases: WebViteHmrCase[] = [
  ...
  },
  {
    ...
    classFrom: '<h1 className="text-[32rpx] font-semibold">',
    classTo: '<h1 data-web-vite-hmr="react-rsbuild-v4" className="text-[red] font-semibold">',
  ...
  },
  {
    ...
    classFrom: '<h1 class="text-[32rpx] font-semibold">',
    classTo: '<h1 data-web-vite-hmr="vue-rsbuild-v4" class="text-[red] font-semibold">',
  ...
  },
  {
    ...
    classFrom: '<h1 className="text-[32rpx] font-semibold">',
    classTo: '<h1 data-web-vite-hmr="react-webpack-v4" className="text-[red] font-semibold">',
  ...
  },
  {
    ...
    classFrom: '<h1 class="text-[32rpx] font-semibold">',
    classTo: '<h1 data-web-vite-hmr="vue-webpack-v4" class="text-[red] font-semibold">',
