...
/* tokens: mt-4 <= pages/index/index.wxml */
.mt-4 {
...
/* tokens: rounded <= pages/index/index.wxml */
.rounded {
  border-radius: 8rpx;
}
...
/* tokens: bg-white <= pages/index/index.wxml */
.bg-white {
...
/* tokens: px-3 <= pages/index/index.wxml */
.px-3 {
  padding-left: calc(var(--spacing) * 3);
  padding-right: calc(var(--spacing) * 3);
}
/* tokens: px-4 <= pages/index/index.wxml */
.px-4 {
  padding-left: calc(var(--spacing) * 4);
  padding-right: calc(var(--spacing) * 4);
}
/* tokens: py-2 <= pages/index/index.wxml */
.py-2 {
  padding-top: calc(var(--spacing) * 2);
  padding-bottom: calc(var(--spacing) * 2);
}
/* tokens: py-3 <= pages/index/index.wxml */
.py-3 {
...
/* tokens: text-slate-900 <= pages/index/index.wxml */
.text-slate-900 {
...
/* tokens: dark:bg-zinc-900 <= pages/index/index.wxml | theme-dark <= pages/index/index.wxml */
.dark_cbg-zinc-900.theme-dark {
  background-color: var(--color-zinc-900);
}
/* tokens: theme-dark <= pages/index/index.wxml | dark:bg-zinc-900 <= pages/index/index.wxml */
.theme-dark .dark_cbg-zinc-900 {
  background-color: var(--color-zinc-900);
}
/* tokens: dark:bg-zinc-950 <= pages/index/index.wxml | theme-dark <= pages/index/index.wxml */
