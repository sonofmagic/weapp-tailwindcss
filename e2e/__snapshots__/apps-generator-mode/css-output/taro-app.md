# taro-app CSS Output Comparison

Fixture: demo
Entry: taro-app/dist/app.wxss
Legacy CSS files: app.wxss, index.wxss, index.wxss, index.wxss, index.wxss, index.wxss
Generator CSS files: app.wxss, index.wxss, index.wxss, index.wxss, index.wxss, index.wxss

| Mode | Bytes | Selectors | @supports | :hover | Tailwind banner | Raw arbitrary selector | Weapp escaped arbitrary selector |
| --- | ---: | ---: | --- | --- | --- | --- | --- |
| legacy | 40513 | 144 | false | false | false | false | true |
| generator | 114523 | 144 | false | false | false | false | true |
...
.rotate-45 {
  ...
  -ms-transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x))
    scaleY(var(--tw-scale-y));
