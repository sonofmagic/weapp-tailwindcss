...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| vite-native | apps | 通过 | `vite-native/dist/app.wxss` (+2) | 6910 | 7307 | +397 | 1.0575 | 否 | 否 | 否 |
| vite-native-ts | apps | 通过 | `vite-native-ts/dist/app.wxss` (+3) | 12485 | 19347 | +6862 | 1.5496 | 否 | 否 | 否 |
| uni-app-vue3-vite | demo | 通过 | `uni-app-vue3-vite/dist/build/mp-weixin/app.wxss` (+10) | 401919 | 234371 | -167548 | 0.5831 | 否 | 否 | 否 |
| uni-app-tailwindcss-v4 | demo | 通过 | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 55257 | 88629 | +33372 | 1.6039 | 否 | 否 | 否 |
| uni-app-tailwindcss-v5 | demo | 通过 | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 64862 | 97476 | +32614 | 1.5028 | 否 | 否 | 否 |
...
| taro-app-vite | demo | 通过 | `taro-app-vite/dist/app.wxss` (+2) | 4530 | 2525 | -2005 | 0.5574 | 否 | 否 | 否 |
