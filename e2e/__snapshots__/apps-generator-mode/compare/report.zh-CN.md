...
| --- | --- | --- | --- | ---: | ---: | --- | --- | --- | --- | --- |
| vite-native | apps | 通过 | `vite-native/dist/app.wxss` (+2) | 7551 | 60 | 否 | 否 | 否 | 否 | 是 |
| vite-native-ts | apps | 通过 | `vite-native-ts/dist/app.wxss` (+3) | 24266 | 258 | 否 | 否 | 否 | 否 | 是 |
| uni-app-vue3-vite | demo | 通过 | `uni-app-vue3-vite/dist/build/mp-weixin/app.wxss` (+10) | 503295 | 3122 | 否 | 否 | 否 | 否 | 是 |
| uni-app-tailwindcss-v4 | demo | 通过 | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 75536 | 235 | 否 | 否 | 否 | 否 | 是 |
| uni-app-tailwindcss-v5 | demo | 通过 | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 77221 | 246 | 否 | 否 | 否 | 否 | 是 |
| taro-app | demo | 通过 | `taro-app/dist/app.wxss` (+5) | 49085 | 139 | 否 | 否 | 否 | 否 | 是 |
| taro-webpack-tailwindcss-v4 | demo | 通过 | `taro-webpack-tailwindcss-v4/dist/app.wxss` (+1) | 348913 | 2152 | 否 | 否 | 否 | 否 | 是 |
| taro-app-vite | demo | 通过 | `taro-app-vite/dist/app.wxss` (+2) | 5227 | 45 | 否 | 否 | 否 | 否 | 是 |
| taro-vite-tailwindcss-v4 | demo | 通过 | `taro-vite-tailwindcss-v4/dist/app.wxss` (+2) | 582 | 6 | 否 | 否 | 否 | 否 | 否 |
| taro-vite-tailwindcss-v5 | demo | 通过 | `taro-vite-tailwindcss-v5/dist/app.wxss` (+2) | 582 | 6 | 否 | 否 | 否 | 否 | 否 |
| taro-vue3-app | demo | 通过 | `taro-vue3-app/dist/app.wxss` (+1) | 200820 | 297 | 否 | 否 | 否 | 否 | 是 |
| gulp-app | demo | 通过 | `gulp-app/dist/app.wxss` (+2) | 6575 | 43 | 否 | 否 | 否 | 否 | 是 |
| mpx-app | demo | 通过 | `mpx-app/dist/wx/app.wxss` (+23) | 189966 | 2877 | 否 | 否 | 否 | 否 | 是 |
| mpx-tailwindcss-v4 | demo | 通过 | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+6) | 16002 | 66 | 否 | 否 | 否 | 否 | 是 |
| mpx-tailwindcss-v5 | demo | 通过 | `mpx-tailwindcss-v5/dist/wx/app.wxss` (+3) | 10749 | 67 | 否 | 否 | 否 | 否 | 是 |
...
- 选择器：`.-start`, `._estart`, `.bg-_b_h3a32d1_B`, `.bg-_b_h68c828_B`, `.bg-amber-300`, `.bg-blue-500_f30`, `.bg-gradient-to-b`, `.bg-gradient-to-t`, `.bg-gradient-to-tr`, `.bg-zinc-50`, `.block`, `.border-4`, `.capitalize`, `.container`, `.dark_cbg-zinc-900`, `.filter`, `.flex`, `.flex-col`, `.from-_b_h2f73f1_B`, `.h-10`
...
- CSS 文件：`app.wxss`, `app-origin.wxss`, `index.wxss`
- 选择器：`.container`, `.tw-page-style-watch-anchor`, `.tw-root`, `:host`, `page`, `wx-root-portal-content`
