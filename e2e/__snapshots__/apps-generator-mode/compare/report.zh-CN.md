...
| uni-app-tailwindcss-v4 | demo | 通过 | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 49689 | 85394 | +35705 | 1.7186 | 否 | 否 | 否 |
| uni-app-tailwindcss-v5 | demo | 通过 | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 58430 | 93845 | +35415 | 1.6061 | 否 | 否 | 否 |
...
- 仅旧链路：`:-moz-focusring`, `:-moz-ui-invalid`, `::-webkit-calendar-picker-indicator`, `::-webkit-date-and-time-value`, `::-webkit-datetime-edit`, `::-webkit-datetime-edit-day-field`, `::-webkit-datetime-edit-fields-wrapper`, `::-webkit-datetime-edit-hour-field`, `::-webkit-datetime-edit-meridiem-field`, `::-webkit-datetime-edit-millisecond-field`, `::-webkit-datetime-edit-minute-field`, `::-webkit-datetime-edit-month-field`, `::-webkit-datetime-edit-second-field`, `::-webkit-datetime-edit-year-field`, `::-webkit-inner-spin-button`, `::-webkit-input-placeholder`, `::-webkit-outer-spin-button`, `::-webkit-search-decoration`, `::placeholder`, `[hidden]:where(:not([hidden='until-found']))`
