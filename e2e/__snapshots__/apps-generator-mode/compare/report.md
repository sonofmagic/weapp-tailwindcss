...
| taro-vite-vue3-tailwindcss-v3 | demo | passed | `taro-vite-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 15273 | 39 | no | no | no | no | yes |
| taro-vite-vue3-tailwindcss-v4 | demo | passed | `taro-vite-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 13526 | 35 | no | no | no | no | yes |
| uni-app-vite-tailwindcss-v3 | demo | passed | `uni-app-vite-tailwindcss-v3/dist/build/mp-weixin/app.wxss` (+11) | 434799 | 3105 | no | no | no | no | yes |
...
| weapp-vite-tailwindcss-v3 | demo | passed | `weapp-vite-tailwindcss-v3/dist/app.wxss` (+5) | 69688 | 262 | no | no | no | no | yes |
