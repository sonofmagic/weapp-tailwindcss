...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| vite-native | apps | passed | `vite-native/dist/app.wxss` (+2) | 5991 | 6707 | +716 | 1.1195 | no | no | no |
| vite-native-ts | apps | passed | `vite-native-ts/dist/app.wxss` (+3) | 12485 | 7061 | -5424 | 0.5656 | no | no | no |
...
| taro-app | demo | passed | `taro-app/dist/app.wxss` (+5) | 40513 | 60894 | +20381 | 1.5031 | no | no | no |
...
| taro-vue3-app | demo | passed | `taro-vue3-app/dist/app.wxss` (+1) | 115828 | 122660 | +6832 | 1.059 | no | no | no |
| gulp-app | demo | passed | `gulp-app/dist/app.wxss` (+2) | 6567 | 7087 | +520 | 1.0792 | no | no | no |
| mpx-app | demo | passed | `mpx-app/dist/wx/app.wxss` (+23) | 189931 | 193567 | +3636 | 1.0191 | no | no | no |
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+3) | 18986 | 22002 | +3016 | 1.1589 | no | no | no |
| mpx-tailwindcss-v5 | demo | passed | `mpx-tailwindcss-v5/dist/wx/app.wxss` (+3) | 22440 | 24452 | +2012 | 1.0897 | no | no | no |
