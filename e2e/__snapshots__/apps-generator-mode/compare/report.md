...
| --- | --- | --- | --- | ---: | ---: | --- | --- | --- | --- | --- |
| gulp-tailwindcss-v3 | demo | passed | `gulp-tailwindcss-v3/dist/app.wxss` (+4) | 15986 | 49 | no | no | no | no | yes |
| gulp-tailwindcss-v4 | demo | passed | `gulp-tailwindcss-v4/dist/app.wxss` (+4) | 6670 | 29 | no | no | no | no | yes |
| mpx-tailwindcss-v3 | demo | passed | `mpx-tailwindcss-v3/dist/wx/app.wxss` (+23) | 190580 | 2879 | no | no | no | no | yes |
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+7) | 19824 | 68 | no | no | no | no | yes |
| taro-webpack-react-tailwindcss-v3 | demo | passed | `taro-webpack-react-tailwindcss-v3/dist/app.wxss` (+7) | 37851 | 97 | no | no | no | no | yes |
...
| taro-vite-react-tailwindcss-v3 | demo | passed | `taro-vite-react-tailwindcss-v3/dist/app.wxss` (+4) | 15028 | 42 | no | no | no | no | yes |
| taro-vite-react-tailwindcss-v4 | demo | passed | `taro-vite-react-tailwindcss-v4/dist/app.wxss` (+3) | 6610 | 38 | no | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v3 | demo | passed | `taro-webpack-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 5633 | 46 | no | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v4 | demo | passed | `taro-webpack-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 3855 | 16 | no | no | no | no | yes |
| taro-vite-vue3-tailwindcss-v3 | demo | passed | `taro-vite-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 14788 | 39 | no | no | no | no | yes |
| taro-vite-vue3-tailwindcss-v4 | demo | passed | `taro-vite-vue3-tailwindcss-v4/dist/app.wxss` (+2) | 6492 | 35 | no | no | no | no | yes |
| uni-app-vite-tailwindcss-v3 | demo | passed | `uni-app-vite-tailwindcss-v3/dist/build/mp-weixin/app.wxss` (+12) | 647342 | 3122 | no | no | no | no | yes |
...
| weapp-vite-tailwindcss-v3 | demo | passed | `weapp-vite-tailwindcss-v3/dist/app.wxss` (+5) | 70652 | 262 | no | no | no | no | yes |
