...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| vite-native | apps | passed | `vite-native/dist/app.wxss` (+2) | 5991 | 12564 | +6573 | 2.0971 | no | no | no |
| vite-native-ts | apps | passed | `vite-native-ts/dist/app.wxss` (+3) | 12485 | 40881 | +28396 | 3.2744 | no | no | no |
| uni-app-vue3-vite | demo | passed | `uni-app-vue3-vite/dist/build/mp-weixin/app.wxss` (+10) | 401919 | 478099 | +76180 | 1.1895 | no | no | no |
| uni-app-tailwindcss-v4 | demo | passed | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 49689 | 88436 | +38747 | 1.7798 | no | no | no |
| uni-app-tailwindcss-v5 | demo | passed | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 58430 | 97283 | +38853 | 1.6649 | no | no | no |
...
| taro-vite-tailwindcss-v4 | demo | passed | `taro-vite-tailwindcss-v4/dist/app.wxss` (+2) | 2082 | 5184 | +3102 | 2.4899 | no | no | no |
| taro-vite-tailwindcss-v5 | demo | passed | `taro-vite-tailwindcss-v5/dist/app.wxss` (+2) | 4505 | 23038 | +18533 | 5.1139 | no | no | no |
| taro-vue3-app | demo | passed | `taro-vue3-app/dist/app.wxss` (+1) | 115828 | 128335 | +12507 | 1.108 | no | no | no |
