...
- Legacy only: `a`, `abbr:where([title])`, `audio`, `b`, `button`, `canvas`, `code`, `embed`, `h1`, `h2`, `h3`, `h4`, `h5`, `h6`, `hr`, `html`, `iframe`, `img`, `input`, `input:where([type='button'], [type='reset'], [type='submit'])`
