...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| vite-native | apps | passed | `vite-native/dist/app.wxss` (+2) | 7049 | 7307 | +258 | 1.0366 | no | no | no |
| vite-native-ts | apps | passed | `vite-native-ts/dist/app.wxss` (+3) | 12527 | 19347 | +6820 | 1.5444 | no | no | no |
| uni-app-vue3-vite | demo | passed | `uni-app-vue3-vite/dist/build/mp-weixin/app.wxss` (+10) | 402079 | 234371 | -167708 | 0.5829 | no | no | no |
| uni-app-tailwindcss-v4 | demo | passed | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 47746 | 97875 | +50129 | 2.0499 | no | no | no |
| uni-app-tailwindcss-v5 | demo | passed | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 56757 | 106324 | +49567 | 1.8733 | no | no | no |
| taro-app | demo | passed | `taro-app/dist/app.wxss` (+5) | 48553 | 52777 | +4224 | 1.087 | no | no | no |
| taro-webpack-tailwindcss-v4 | demo | passed | `taro-webpack-tailwindcss-v4/dist/app.wxss` (+1) | 383463 | 10654 | -372809 | 0.0278 | no | no | no |
| taro-app-vite | demo | passed | `taro-app-vite/dist/app.wxss` (+2) | 4698 | 2525 | -2173 | 0.5375 | no | no | no |
| taro-vite-tailwindcss-v4 | demo | passed | `taro-vite-tailwindcss-v4/dist/app.wxss` (+2) | 3646 | 5601 | +1955 | 1.5362 | no | no | no |
| taro-vite-tailwindcss-v5 | demo | passed | `taro-vite-tailwindcss-v5/dist/app.wxss` (+2) | 6600 | 23241 | +16641 | 3.5214 | no | no | no |
| taro-vue3-app | demo | passed | `taro-vue3-app/dist/app.wxss` (+1) | 118508 | 12507 | -106001 | 0.1055 | no | no | no |
| gulp-app | demo | passed | `gulp-app/dist/app.wxss` (+2) | 6578 | 5999 | -579 | 0.912 | no | no | no |
| mpx-app | demo | passed | `mpx-app/dist/wx/app.wxss` (+16) | 189931 | 19333 | -170598 | 0.1018 | no | no | no |
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+3) | 21126 | 10498 | -10628 | 0.4969 | no | no | no |
| mpx-tailwindcss-v5 | demo | passed | `mpx-tailwindcss-v5/dist/wx/app.wxss` (+3) | 25140 | 11586 | -13554 | 0.4609 | no | no | no |
...
- Shared selectors: `.bg-_b_h3a32d1_B`, `.bg-_b_h68c828_B`, `.bg-amber-300`, `.bg-blue-500_f30`, `.bg-gradient-to-b`, `.bg-gradient-to-t`, `.bg-gradient-to-tr`, `.bg-zinc-50`, `.border-4`, `.flex`, `.flex-col`, `.from-_b_h2f73f1_B`, `.h-10`, `.h-_b30px_B`, `.h-_b45px_B`, `.i-mdi-home`, `.inline-block`, `.min-h-screen`, `.p-4`, `.size-12`
- Generator only: `.-start`, `._estart`, `.capitalize`, `.end`, `.filter`, `.inline`, `.invert`, `.resize`, `.rounded`, `.start`, `.transform`, `.transition`, `.truncate`, `/*$vite$:1*/ /* stylelint-disable-next-line import-notation */ .s .a`
- Legacy only: `.container`, `.h-_b29_d292px_B`, `.space-x-2_d5 > text + text`, `.space-x-2_d5 > text + view`, `.space-x-2_d5 > view + text`, `.space-y-2_d5 > text + text`, `.space-y-2_d5 > text + view`, `.space-y-2_d5 > view + text`, `/*$vite$:1*/ /*$vite$:1*/ /* stylelint-disable-next-line import-notation */ .s .a`, `::after`, `::before`, `:after`, `:before`, `text`, `view`
...
- Generator only: `.absolute`, `.antialiased`, `.backdrop-blur`, `.backdrop-filter`, `.backdrop-grayscale`, `.backdrop-invert`, `.backdrop-sepia`, `.bg-repeat`, `.blur`, `.border-b`, `.border-collapse`, `.border-e`, `.border-l`, `.border-r`, `.border-s`, `.border-t`, `.border-x`, `.border-y`, `.capitalize`, `.collapse`
...
- Legacy only: `::-ms-backdrop`, `::-webkit-backdrop`, `::after`, `::before`, `:after`, `:before`, `text`, `view`

### taro-vite-tailwindcss-v5

- CSS files: `app.wxss`, `app-origin.wxss`, `index.wxss`
- Shared selectors: `._eborder-brand`, `.active_cbg-emerald-600:active`, `.bg-_b_h123456_B`, `.bg-brand`, `.bg-gradient-to-b`, `.bg-gradient-to-r`, `.bg-gray-100`, `.bg-linear-to-r`, `.bg-red-500`, `.border-_b10rpx_B`, `.from-cyan-500`, `.from-fuchsia-500`, `.h-14`, `.h-_b300px_B`, `.p-4`, `.p-_b32rpx_B`, `.rotate-_b10deg_B`, `.rounded-xl`, `.space-y-4 > view + view`, `.static`
- Generator only: `.absolute`, `.antialiased`, `.backdrop-blur`, `.backdrop-filter`, `.backdrop-grayscale`, `.backdrop-invert`, `.backdrop-sepia`, `.bg-repeat`, `.block`, `.blur`, `.border`, `.border-b`, `.border-collapse`, `.border-e`, `.border-l`, `.border-r`, `.border-s`, `.border-t`, `.border-x`, `.border-y`
- Legacy only: `.dark_cbg-zinc-800`, `.space-y-4 > text + text`, `.space-y-4 > text + view`, `.space-y-4 > view + text`, `::-ms-backdrop`, `::-webkit-backdrop`, `::after`, `::before`, `:after`, `:before`, `text`, `view`
...
- Generator only: -
- Legacy only: `.i-mdi-123`, `.i-mdi-ab-testing`, `.i-mdi-abacus`, `.i-mdi-typewriter`, `.more__pre`, `.more__pre text`, `.space-y-1 > text + text`, `.space-y-1 > text + view`, `.space-y-1 > view + text`, `.space-y-4 > text + text`, `.space-y-4 > text + view`, `.space-y-4 > view + text`, `::after`, `::before`, `text`, `view`

### mpx-app

- CSS files: `app.wxss`, `styles/base.wxss`, `styles/components.wxss`, `styles/utilities.wxss`, `index.wxss`, `button.wxss`, `icon.wxss`, `loading.wxss`, `index.wxss`, `index.wxss`, `index.wxss`, `index.wxss`, `base5c682eff.wxss`, `components1e38aa04.wxss`, `indexd323f158.wxss`, `indexfcda771e.wxss`, `utilities68e69726.wxss`
- Shared selectors: `.bg-_b_h123456_B`, `.bg-_b_h929292_B`, `.bg-_burl_p_ahttps_c_f_fxxx_dcom_fxx_dwebp_a_P_B`, `.flex`, `.flex-col`, `.text-_b_he67240_B`, `.text-_bblue_B`
...
- Legacy only: `.-mt-2`, `._2xl_ctext-_bred_B`, `.after_cborder-none:after`, `.before_ccontent-_b_aFestivus_a_B:before`, `.bg-gray-100`, `.bg-pink-500`, `.bg-red-400`, `.bg-red-500`, `.bg-sky-500`, `.border`, `.border-solid`, `.dark_cbg-zinc-800`, `.dark_ctext-yellow-400`, `.divide-_b_h010101_B > text + text`, `.divide-_b_h010101_B > text + view`, `.divide-_b_h010101_B > view + text`, `.divide-solid > text + text`, `.divide-solid > text + view`, `.divide-solid > view + text`, `.divide-solid > view + view`

### mpx-tailwindcss-v5

- CSS files: `app.wxss`, `styles/app.wxss`, `index.wxss`, `app252bdc3c.wxss`
...
- Generator only: `.after_cborder-none::after`, `.before_ccontent-_b_aFestivus_a_B::before`
- Legacy only: `.-mt-2`, `._2xl_ctext-_bred_B`, `.after_cborder-none:after`, `.before_ccontent-_b_aFestivus_a_B:before`, `.bg-emerald-500`, `.bg-gradient-to-r`, `.bg-gray-100`, `.bg-pink-500`, `.bg-red-400`, `.bg-red-500`, `.bg-sky-500`, `.border`, `.border-solid`, `.dark_cbg-zinc-800`, `.dark_ctext-yellow-400`, `.divide-_b_h010101_B > text + text`, `.divide-_b_h010101_B > text + view`, `.divide-_b_h010101_B > view + text`, `.divide-solid > text + text`, `.divide-solid > text + view`
