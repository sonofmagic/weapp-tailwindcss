...
| taro-vite-react-tailwindcss-v3 | demo | passed | `taro-vite-react-tailwindcss-v3/dist/app.wxss` (+1) | 10290 | 45 | no | no | no | yes | yes | no | no | no | yes |
| taro-vite-react-tailwindcss-v4 | demo | passed | `taro-vite-react-tailwindcss-v4/dist/app.wxss` (+1) | 7867 | 37 | no | no | no | yes | yes | no | no | no | yes |
...
| uni-app-vite-tailwindcss-v4 | demo | passed | `uni-app-vite-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+4) | 37690 | 135 | no | no | no | yes | yes | no | no | no | yes |
| weapp-vite-tailwindcss-v3 | demo | passed | `weapp-vite-tailwindcss-v3/dist/app.wxss` (+8) | 148281 | 181 | no | no | no | yes | yes | no | no | no | yes |
