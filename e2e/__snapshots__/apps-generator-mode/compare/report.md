...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| vite-native | apps | passed | `vite-native/dist/app.wxss` (+2) | 6910 | 15189 | +8279 | 2.1981 | no | no | no |
| vite-native-ts | apps | passed | `vite-native-ts/dist/app.wxss` (+3) | 12485 | 40881 | +28396 | 3.2744 | no | no | no |
| uni-app-vue3-vite | demo | passed | `uni-app-vue3-vite/dist/build/mp-weixin/app.wxss` (+10) | 401919 | 517083 | +115164 | 1.2865 | no | no | no |
| uni-app-tailwindcss-v4 | demo | passed | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 55257 | 88859 | +33602 | 1.6081 | no | no | no |
| uni-app-tailwindcss-v5 | demo | passed | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 64862 | 97706 | +32844 | 1.5064 | no | no | no |
| taro-app | demo | passed | `taro-app/dist/app.wxss` (+5) | 48553 | 122339 | +73786 | 2.5197 | no | no | no |
...
| taro-vue3-app | demo | passed | `taro-vue3-app/dist/app.wxss` (+1) | 118508 | 129522 | +11014 | 1.0929 | no | no | no |
| gulp-app | demo | passed | `gulp-app/dist/app.wxss` (+2) | 6578 | 12564 | +5986 | 1.91 | no | no | no |
| mpx-app | demo | passed | `mpx-app/dist/wx/app.wxss` (+16) | 189931 | 202476 | +12545 | 1.0661 | no | no | no |
...
- Generator only: -
- Legacy only: `::after`, `::before`, `text`, `view`
