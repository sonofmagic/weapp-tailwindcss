...
| gulp-tailwindcss-v4 | demo | passed | `gulp-tailwindcss-v4/dist/app.wxss` (+4) | 6666 | 29 | no | no | no | no | yes |
| mpx-tailwindcss-v3 | demo | passed | `mpx-tailwindcss-v3/dist/wx/app.wxss` (+23) | 194068 | 2879 | no | no | no | no | yes |
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+3) | 9491 | 68 | no | no | no | no | yes |
| taro-webpack-react-tailwindcss-v3 | demo | passed | `taro-webpack-react-tailwindcss-v3/dist/app.wxss` (+7) | 35370 | 97 | no | no | no | no | yes |
| taro-webpack-react-tailwindcss-v4 | demo | passed | `taro-webpack-react-tailwindcss-v4/dist/app.wxss` (+3) | 300687 | 2146 | no | no | no | no | yes |
| taro-vite-react-tailwindcss-v3 | demo | passed | `taro-vite-react-tailwindcss-v3/dist/app.wxss` (+4) | 10233 | 25 | no | no | no | no | yes |
| taro-vite-react-tailwindcss-v4 | demo | passed | `taro-vite-react-tailwindcss-v4/dist/app.wxss` (+4) | 11916 | 21 | no | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v3 | demo | passed | `taro-webpack-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 5728 | 46 | no | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v4 | demo | passed | `taro-webpack-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 4335 | 15 | no | no | no | no | yes |
| taro-vite-vue3-tailwindcss-v3 | demo | passed | `taro-vite-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 18475 | 39 | no | no | no | no | yes |
| taro-vite-vue3-tailwindcss-v4 | demo | passed | `taro-vite-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 14157 | 35 | no | no | no | no | yes |
| uni-app-vite-tailwindcss-v3 | demo | passed | `uni-app-vite-tailwindcss-v3/dist/build/mp-weixin/app.wxss` (+12) | 693802 | 3120 | no | no | no | no | yes |
| uni-app-vite-tailwindcss-v4 | demo | passed | `uni-app-vite-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+4) | 43063 | 233 | no | no | no | no | yes |
| weapp-vite-tailwindcss-v3 | demo | passed | `weapp-vite-tailwindcss-v3/dist/app.wxss` (+5) | 84705 | 262 | no | no | no | no | yes |
| weapp-vite-tailwindcss-v4 | demo | passed | `weapp-vite-tailwindcss-v4/dist/app.wxss` (+5) | 8370 | 47 | no | no | no | no | yes |
