...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| vite-native | apps | passed | `vite-native/dist/app.wxss` (+2) | 5991 | 6881 | +890 | 1.1486 | no | no | no |
| vite-native-ts | apps | passed | `vite-native-ts/dist/app.wxss` (+3) | 12485 | 7181 | -5304 | 0.5752 | no | no | no |
| uni-app-vue3-vite | demo | passed | `uni-app-vue3-vite/dist/build/mp-weixin/app.wxss` (+10) | 401919 | 402814 | +895 | 1.0022 | no | no | no |
| uni-app-tailwindcss-v4 | demo | passed | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 49689 | 93710 | +44021 | 1.8859 | no | no | no |
| uni-app-tailwindcss-v5 | demo | passed | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 58430 | 102557 | +44127 | 1.7552 | no | no | no |
| taro-app | demo | passed | `taro-app/dist/app.wxss` (+5) | 40513 | 60003 | +19490 | 1.4811 | no | no | no |
| taro-webpack-tailwindcss-v4 | demo | passed | `taro-webpack-tailwindcss-v4/dist/app.wxss` (+1) | 382159 | 381648 | -511 | 0.9987 | no | no | no |
| taro-app-vite | demo | passed | `taro-app-vite/dist/app.wxss` (+2) | 4530 | 1601 | -2929 | 0.3534 | no | no | no |
| taro-vite-tailwindcss-v4 | demo | passed | `taro-vite-tailwindcss-v4/dist/app.wxss` (+2) | 2082 | 5184 | +3102 | 2.4899 | no | no | no |
| taro-vite-tailwindcss-v5 | demo | passed | `taro-vite-tailwindcss-v5/dist/app.wxss` (+2) | 4505 | 23656 | +19151 | 5.2511 | no | no | no |
| taro-vue3-app | demo | passed | `taro-vue3-app/dist/app.wxss` (+1) | 115828 | 122498 | +6670 | 1.0576 | no | no | no |
| gulp-app | demo | passed | `gulp-app/dist/app.wxss` (+2) | 6567 | 6610 | +43 | 1.0065 | no | no | no |
| mpx-app | demo | passed | `mpx-app/dist/wx/app.wxss` (+23) | 189931 | 193567 | +3636 | 1.0191 | no | no | no |
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+3) | 18986 | 20722 | +1736 | 1.0914 | no | no | no |
| mpx-tailwindcss-v5 | demo | passed | `mpx-tailwindcss-v5/dist/wx/app.wxss` (+3) | 22440 | 23172 | +732 | 1.0326 | no | no | no |
