...
| taro-webpack-react-tailwindcss-v3 | demo | passed | `taro-webpack-react-tailwindcss-v3/dist/app.wxss` (+5) | 48665 | 139 | no | no | no | no | yes |
| taro-webpack-react-tailwindcss-v4 | demo | passed | `taro-webpack-react-tailwindcss-v4/dist/app.wxss` (+1) | 365148 | 2154 | no | no | no | no | yes |
| taro-vite-react-tailwindcss-v3 | demo | passed | `taro-vite-react-tailwindcss-v3/dist/app.wxss` (+2) | 5227 | 45 | no | no | no | no | yes |
| taro-vite-react-tailwindcss-v4 | demo | passed | `taro-vite-react-tailwindcss-v4/dist/app.wxss` (+2) | 5001 | 39 | no | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v3 | demo | passed | `taro-webpack-vue3-tailwindcss-v3/dist/app.wxss` | 4883 | 47 | no | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v4 | demo | passed | `taro-webpack-vue3-tailwindcss-v4/dist/app.wxss` | 1869 | 19 | no | no | no | no | yes |
| taro-vite-vue3-tailwindcss-v3 | demo | passed | `taro-vite-vue3-tailwindcss-v3/dist/app.wxss` (+1) | 5281 | 46 | no | no | no | no | yes |
| taro-vite-vue3-tailwindcss-v4 | demo | passed | `taro-vite-vue3-tailwindcss-v4/dist/app.wxss` (+1) | 5055 | 40 | no | no | no | no | yes |
...
- CSS files: `app.wxss`
- Selectors: `.bg-_b_h123456_B`, `.bg-_b_h534312_B`, `.bg-gradient-to-r`, `.bg-purple-800`, `.from-cyan-500`, `.h-14`, `.px-_b32px_B`, `.py-_b18px_B`, `.rounded-_b24rpx_B`, `.static`, `.text-_b100rpx_B`, `.text-_b_hfff_B`, `.text-_b_hffffff_B`, `.text-pink-200`, `.to-blue-500`, `.tw-root`, `:host`, `page`, `wx-root-portal-content`

### taro-vite-vue3-tailwindcss-v3

- CSS files: `app.wxss`, `app-origin.wxss`
- Selectors: `.absolute`, `.before_ccontent-_b_a11111_a_B:before`, `.before_ccontent-_b_a222_a_B:before`, `.bg-_b_h89ab8d_B`, `.bg-_b_he24826_B`, `.block`, `.blur`, `.border`, `.capitalize`, `.container`, `.dark_ctext-_b_hec4f4f_B`, `.divide-_b_h60d256_B > text + text`, `.divide-_b_h60d256_B > text + view`, `.divide-_b_h60d256_B > view + text`, `.divide-_b_h60d256_B > view + view`, `.divide-solid > text + text`, `.divide-solid > text + view`, `.divide-solid > view + text`, `.divide-solid > view + view`, `.divide-x-8 > text + text`

### taro-vite-vue3-tailwindcss-v4

- CSS files: `app.wxss`, `app-origin.wxss`
- Selectors: `.absolute`, `.bg-_b_h123456_B`, `.bg-gradient-to-r`, `.bg-linear-to-r`, `.bg-purple-300`, `.block`, `.blur`, `.border`, `.capitalize`, `.container`, `.ease-out`, `.filter`, `.fixed`, `.flex`, `.flex-grow`, `.flex-shrink`, `.from-cyan-500`, `.grid`, `.h-14`, `.h-_b300px_B`
