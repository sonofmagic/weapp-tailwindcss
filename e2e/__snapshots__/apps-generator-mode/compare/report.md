...
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+2) | 9726 | 79 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-react-tailwindcss-v3 | demo | passed | `taro-webpack-react-tailwindcss-v3/dist/app.wxss` (+7) | 97192 | 108 | no | no | no | yes | yes | no | no | no | yes |
...
| taro-vite-react-tailwindcss-v3 | demo | passed | `taro-vite-react-tailwindcss-v3/dist/app.wxss` (+2) | 10340 | 46 | no | no | no | yes | yes | no | no | no | yes |
| taro-vite-react-tailwindcss-v4 | demo | passed | `taro-vite-react-tailwindcss-v4/dist/app.wxss` (+2) | 7917 | 38 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v3 | demo | passed | `taro-webpack-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 26365 | 57 | no | no | no | yes | yes | no | no | no | yes |
...
| taro-vite-vue3-tailwindcss-v3 | demo | passed | `taro-vite-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 13391 | 45 | no | no | no | yes | yes | no | no | no | yes |
| taro-vite-vue3-tailwindcss-v4 | demo | passed | `taro-vite-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 9457 | 36 | no | no | no | yes | yes | no | no | no | yes |
| uni-app-vite-tailwindcss-v3 | demo | passed | `uni-app-vite-tailwindcss-v3/dist/build/mp-weixin/app.wxss` (+11) | 256258 | 2838 | no | no | no | yes | yes | no | no | no | yes |
| uni-app-vite-tailwindcss-v4 | demo | passed | `uni-app-vite-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+4) | 32703 | 135 | no | no | no | yes | yes | no | no | no | yes |
| weapp-vite-tailwindcss-v3 | demo | passed | `weapp-vite-tailwindcss-v3/dist/app.wxss` (+7) | 119403 | 181 | no | no | no | yes | yes | no | no | no | yes |
| weapp-vite-tailwindcss-v4 | demo | passed | `weapp-vite-tailwindcss-v4/dist/app.wxss` (+4) | 20428 | 83 | no | no | no | yes | yes | no | no | no | yes |
...
- CSS files: `app.wxss`, `pages/component/index.wxss`, `styles/app3b4a1ac6.wxss`
...
- CSS files: `app.wxss`, `components/IceButton/index.wxss`, `miniprogram/app.wxss`, `miniprogram/sub-normal/pages/index.wxss`, `pages/index/index.wxss`, `pages/index/merge/index.wxss`, `sub-independent/pages/index.wxss`, `sub-normal/pages/index.wxss`
