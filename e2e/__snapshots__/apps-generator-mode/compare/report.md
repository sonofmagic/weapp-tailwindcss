...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| vite-native | apps | passed | `vite-native/dist/app.wxss` (+2) | 4820 | 7493 | +2673 | 1.5546 | none | no | no | no |
...
| uni-app-tailwindcss-v4 | demo | passed | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 48504 | 49689 | +1185 | 1.0244 | none | no | no | no |
| uni-app-tailwindcss-v5 | demo | passed | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 57195 | 54032 | -3163 | 0.9447 | none | no | no | no |
| taro-app | demo | passed | `taro-app/dist/app.wxss` (+5) | 40513 | 65747 | +25234 | 1.6229 | none | no | no | no |
| taro-webpack-tailwindcss-v4 | demo | passed | `taro-webpack-tailwindcss-v4/dist/app.wxss` (+1) | 349424 | 365357 | +15933 | 1.0456 | none | no | no | no |
| taro-app-vite | demo | passed | `taro-app-vite/dist/app.wxss` (+2) | 4530 | 4698 | +168 | 1.0371 | none | no | no | no |
| taro-vite-tailwindcss-v4 | demo | passed | `taro-vite-tailwindcss-v4/dist/app.wxss` (+2) | 1915 | 5455 | +3540 | 2.8486 | none | no | no | no |
| taro-vite-tailwindcss-v5 | demo | passed | `taro-vite-tailwindcss-v5/dist/app.wxss` (+2) | 3898 | 23594 | +19696 | 6.0528 | none | no | no | no |
...
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+3) | 16699 | 16743 | +44 | 1.0026 | none | no | no | no |
| mpx-tailwindcss-v5 | demo | passed | `mpx-tailwindcss-v5/dist/wx/app.wxss` (+3) | 19703 | 19747 | +44 | 1.0022 | none | no | no | no |
...
- Generator only: `.-start`, `._estart`, `.capitalize`, `.filter`, `.inline`, `.invert`, `.resize`, `.rounded`, `.transform`, `.transition`, `.truncate`
- Legacy only: -
