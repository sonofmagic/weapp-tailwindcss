...
| mpx-tailwindcss-v4 | demo | wx | `wx`, `ali`, `swan`, `tt`, `dd` | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+9) | 30771 | 185 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-react-tailwindcss-v4 | demo | weapp | `weapp`, `swan`, `alipay`, `tt`, `h5`, `rn`, `qq`, `jd`, `harmony-hybrid` | passed | `taro-webpack-react-tailwindcss-v4/dist/app.wxss` (+3) | 303010 | 2223 | no | no | no | yes | yes | no | no | no | yes |
...
| taro-webpack-vue3-tailwindcss-v4 | demo | weapp | `weapp`, `swan`, `alipay`, `tt`, `h5`, `rn`, `qq`, `jd`, `harmony-hybrid` | passed | `taro-webpack-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 244358 | 1743 | no | no | no | yes | yes | no | no | no | yes |
