...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| vite-native | apps | passed | `vite-native/dist/app.wxss` (+2) | 5712 | 7613 | +1901 | 1.3328 | none | no | no | no |
...
| taro-vite-tailwindcss-v5 | demo | passed | `taro-vite-tailwindcss-v5/dist/app.wxss` (+2) | 4433 | 23764 | +19331 | 5.3607 | none | no | no | no |
...
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+3) | 18826 | 17172 | -1654 | 0.9121 | none | no | no | no |
| mpx-tailwindcss-v5 | demo | passed | `mpx-tailwindcss-v5/dist/wx/app.wxss` (+3) | 22280 | 20252 | -2028 | 0.909 | none | no | no | no |
