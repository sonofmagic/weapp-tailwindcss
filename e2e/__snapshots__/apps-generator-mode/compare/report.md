...
| mpx-tailwindcss-v3 | demo | passed | `mpx-tailwindcss-v3/dist/wx/app.wxss` (+10) | 186807 | 2889 | no | no | no | yes | yes | no | no | no | yes |
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+2) | 9704 | 79 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-react-tailwindcss-v3 | demo | passed | `taro-webpack-react-tailwindcss-v3/dist/app.wxss` (+6) | 97706 | 108 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-react-tailwindcss-v4 | demo | passed | `taro-webpack-react-tailwindcss-v4/dist/app.wxss` (+3) | 389725 | 2494 | no | no | no | yes | yes | no | no | no | yes |
...
| taro-vite-react-tailwindcss-v4 | demo | passed | `taro-vite-react-tailwindcss-v4/dist/app.wxss` (+2) | 9100 | 34 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v3 | demo | passed | `taro-webpack-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 26481 | 57 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v4 | demo | passed | `taro-webpack-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 134542 | 554 | no | no | no | yes | yes | no | no | no | yes |
...
| taro-vite-vue3-tailwindcss-v4 | demo | passed | `taro-vite-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 10654 | 36 | no | no | no | yes | yes | no | no | no | yes |
...
- CSS files: `app.wxss`, `styles/app.wxss`, `pages/component/index.wxss`
