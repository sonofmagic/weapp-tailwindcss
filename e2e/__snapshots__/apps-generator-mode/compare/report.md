...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| vite-native | apps | passed | `vite-native/dist/app.wxss` (+2) | 6158 | 15132 | +8974 | 2.4573 | no | no | no |
...
| uni-app-tailwindcss-v4 | demo | passed | `uni-app-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 55257 | 89720 | +34463 | 1.6237 | no | no | no |
| uni-app-tailwindcss-v5 | demo | passed | `uni-app-tailwindcss-v5/dist/build/mp-weixin/app.wxss` (+2) | 64862 | 98567 | +33705 | 1.5196 | no | no | no |
| taro-app | demo | passed | `taro-app/dist/app.wxss` (+5) | 40513 | 114523 | +74010 | 2.8268 | no | no | no |
| taro-webpack-tailwindcss-v4 | demo | passed | `taro-webpack-tailwindcss-v4/dist/app.wxss` (+1) | 382585 | 381898 | -687 | 0.9982 | no | no | no |
| taro-app-vite | demo | passed | `taro-app-vite/dist/app.wxss` (+2) | 4530 | 2575 | -1955 | 0.5684 | no | no | no |
| taro-vite-tailwindcss-v4 | demo | passed | `taro-vite-tailwindcss-v4/dist/app.wxss` (+2) | 2684 | 5642 | +2958 | 2.1021 | no | no | no |
| taro-vite-tailwindcss-v5 | demo | passed | `taro-vite-tailwindcss-v5/dist/app.wxss` (+2) | 5387 | 23496 | +18109 | 4.3616 | no | no | no |
| taro-vue3-app | demo | passed | `taro-vue3-app/dist/app.wxss` (+1) | 115828 | 128334 | +12506 | 1.108 | no | no | no |
...
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+3) | 21126 | 28382 | +7256 | 1.3435 | no | no | no |
| mpx-tailwindcss-v5 | demo | passed | `mpx-tailwindcss-v5/dist/wx/app.wxss` (+3) | 25140 | 32398 | +7258 | 1.2887 | no | no | no |
...
- Legacy only: `.container`, `.h-_b29_d292px_B`, `.space-x-2_d5 > text + text`, `.space-x-2_d5 > text + view`, `.space-x-2_d5 > view + text`, `.space-y-2_d5 > text + text`, `.space-y-2_d5 > text + view`, `.space-y-2_d5 > view + text`, `:after`, `:before`, `text`, `view`
...
- Legacy only: `.dark_cbg-zinc-800`, `.space-y-4 > text + text`, `.space-y-4 > text + view`, `.space-y-4 > view + text`, `:after`, `:before`, `text`, `view`
