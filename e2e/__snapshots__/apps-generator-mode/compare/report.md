...
| --- | --- | --- | --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| gulp-tailwindcss-v3 | demo | passed | `gulp-tailwindcss-v3/dist/app.wxss` (+4) | 27962 | 67 | no | no | no | yes | yes | no | no | no | yes |
| gulp-tailwindcss-v4 | demo | passed | `gulp-tailwindcss-v4/dist/app.wxss` (+4) | 14242 | 73 | no | no | no | yes | yes | no | no | no | yes |
| mpx-tailwindcss-v3 | demo | passed | `mpx-tailwindcss-v3/dist/wx/app.wxss` (+13) | 186787 | 2889 | no | no | no | yes | yes | no | no | no | yes |
| mpx-tailwindcss-v4 | demo | passed | `mpx-tailwindcss-v4/dist/wx/app.wxss` (+2) | 9728 | 79 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-react-tailwindcss-v3 | demo | passed | `taro-webpack-react-tailwindcss-v3/dist/app.wxss` (+7) | 97198 | 108 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-react-tailwindcss-v4 | demo | passed | `taro-webpack-react-tailwindcss-v4/dist/app.wxss` (+3) | 389625 | 2494 | no | no | no | yes | yes | no | no | no | yes |
| taro-vite-react-tailwindcss-v3 | demo | passed | `taro-vite-react-tailwindcss-v3/dist/app.wxss` (+2) | 5416 | 46 | no | no | no | yes | yes | no | no | no | yes |
| taro-vite-react-tailwindcss-v4 | demo | passed | `taro-vite-react-tailwindcss-v4/dist/app.wxss` (+2) | 3650 | 34 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v3 | demo | passed | `taro-webpack-vue3-tailwindcss-v3/dist/app.wxss` (+3) | 26369 | 57 | no | no | no | yes | yes | no | no | no | yes |
| taro-webpack-vue3-tailwindcss-v4 | demo | passed | `taro-webpack-vue3-tailwindcss-v4/dist/app.wxss` (+3) | 134455 | 554 | no | no | no | yes | yes | no | no | no | yes |
...
| uni-app-vite-tailwindcss-v3 | demo | passed | `uni-app-vite-tailwindcss-v3/dist/build/mp-weixin/app.wxss` (+6) | 263512 | 2836 | no | no | no | yes | yes | no | no | no | yes |
| uni-app-vite-tailwindcss-v4 | demo | passed | `uni-app-vite-tailwindcss-v4/dist/build/mp-weixin/app.wxss` (+2) | 36764 | 133 | no | no | no | yes | yes | no | no | no | yes |
| weapp-vite-tailwindcss-v3 | demo | passed | `weapp-vite-tailwindcss-v3/dist/app.wxss` (+5) | 35298 | 181 | no | no | no | yes | yes | no | no | no | yes |
| weapp-vite-tailwindcss-v4 | demo | passed | `weapp-vite-tailwindcss-v4/dist/app.wxss` (+3) | 19427 | 81 | no | no | no | yes | yes | no | no | no | yes |
...
- CSS files: `app.wxss`, `pages/index/index.wxss`, `pages/more/more.wxss`, `sub-independent/pages/index.wxss`, `sub-normal/pages/index.wxss`
...
- CSS files: `app.wxss`, `pages/component/index.wxss`, `styles/app.wxss`
...
- CSS files: `app.wxss`, `moduleA/pages/index.wxss`, `moduleB/pages/index.wxss`, `moduleC/pages/index.wxss`, `pages/debug/index.wxss`, `pages/index/index.wxss`, `sub-independent/pages/index.wxss`, `sub-normal/pages/index.wxss`
...
- CSS files: `app.wxss`, `app-origin.wxss`, `pages/index/index.wxss`
- Selectors: `.bg-_b_h123456_B`, `.bg-_bred_B`, `.bg-gradient-to-r`, `.bg-linear-to-r`, `.bg-purple-300`, `.bg-white`, `.dark_cbg-zinc-900.theme-dark`, `.dark_cbg-zinc-950.theme-dark`, `.dark_ctext-zinc-50.theme-dark`, `.from-cyan-500`, `.h-14`, `.h-_b300px_B`, `.mt-2`, `.mt-4`, `.px-3`, `.px-4`, `.py-2`, `.py-3`, `.rounded`, `.system-dark_cbg-slate-900`
...
- CSS files: `app.wxss`, `custom-tab-bar/index.wxss`, `node-modules/uview-plus/components/u-button/u-button.wxss`, `node-modules/uview-plus/components/u-loading-icon/u-loading-icon.wxss`, `pages/index/index.wxss`, `pages/index/peer.wxss`, `pages/issue/typography.wxss`
...
- CSS files: `app.wxss`, `pages-order/pages/home/home.wxss`, `pages-order/pages/user/user.wxss`
