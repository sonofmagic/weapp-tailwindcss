...
| mini-program-hmr-memory | passed | 55 | 3710MB | 3289MB | 2086MB | 14 | 54s | `e2e/reports/local-full-run/2026-06-19T03-verify-v3-v4-uni-app-platforms/weapp-memory/README.md`<br>`e2e/reports/local-full-run/2026-06-19T03-verify-v3-v4-uni-app-platforms/weapp-memory/summary.json`<br>`e2e/reports/local-full-run/2026-06-19T03-verify-v3-v4-uni-app-platforms/weapp-memory/projects/uni-app-vite-tailwindcss-v4.md`<br>`e2e/reports/local-full-run/2026-06-19T03-verify-v3-v4-uni-app-platforms/weapp-memory/projects/uni-app-vite-tailwindcss-v4.md`<br>`e2e/reports/local-full-run/2026-06-19T03-verify-v3-v4-uni-app-platforms/hmr/hmr-full-report-2026-06-19T02-09-23-627Z.json`<br>`e2e/reports/local-full-run/2026-06-19T03-verify-v3-v4-uni-app-platforms/hmr/hmr-full-report-2026-06-19T02-09-23-627Z.md`<br>`e2e/reports/local-full-run/2026-06-19T03-verify-v3-v4-uni-app-platforms/hmr/hmr-full-report-2026-06-19T02-09-57-969Z.json`<br>`e2e/reports/local-full-run/2026-06-19T03-verify-v3-v4-uni-app-platforms/hmr/hmr-full-report-2026-06-19T02-09-57-969Z.md` | `pnpm e2e:demo:weapp-memory --out-dir .tmp/local-full-report-weapp-memory` |
| platform-build-uni-app-vite-tailwindcss-v4-h5 | passed | 8 | 4594MB | 4032MB | 1391MB | 143 | 7s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-h5-ssr | passed | 9 | 4382MB | 3808MB | 1430MB | 144 | 8s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-mp-alipay | passed | 6 | 1465MB | 920MB | 800MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-mp-baidu | passed | 6 | 1430MB | 869MB | 772MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-mp-kuaishou | passed | 6 | 1483MB | 910MB | 810MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-mp-lark | passed | 6 | 1461MB | 901MB | 803MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-mp-qq | passed | 6 | 1446MB | 880MB | 779MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-mp-toutiao | passed | 6 | 1468MB | 904MB | 808MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-mp-weixin | passed | 6 | 1532MB | 965MB | 818MB | 8 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-quickapp-webview | passed | 6 | 1443MB | 878MB | 777MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-quickapp-webview-huawei | passed | 6 | 1488MB | 918MB | 817MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
| platform-build-uni-app-vite-tailwindcss-v4-quickapp-webview-union | passed | 6 | 1438MB | 872MB | 773MB | 7 | 5s | - | `pnpm e2e:multiplatform-build` |
...
| h5-dev-uni-app-vite-tailwindcss-v4 | passed | 3 | 936MB | 330MB | 329MB | 8 | 2s | - | `pnpm exec vitest run --bail=1 -c ./e2e/vitest.e2e.config.ts e2e/uni-app-vite-tailwindcss-dev-h5.test.ts -t "uni-app vite Tailwind v4"` |
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| uni-app-vite-tailwindcss-v4 | v3 | app-android | local | local | - | - | - | Android 调试依赖本机 HBuilderX 与 Android 模拟器。 | local | local | - | - | - | - | Android 调试依赖本机 HBuilderX 与 Android 模拟器。 |
| uni-app-vite-tailwindcss-v4 | v3 | app-ios | local | local | - | - | - | iOS 调试依赖 macOS Simulator 与 HBuilderX。 | local | local | - | - | - | - | iOS 调试依赖 macOS Simulator 与 HBuilderX。 |
| uni-app-vite-tailwindcss-v4 | v3 | h5 | automated | passed | 7s | 4594MB | 4032MB | step:platform-build-uni-app-vite-tailwindcss-v4-h5 | automated | passed | 2002ms | - | 936MB | - | step:h5-dev-uni-app-vite-tailwindcss-v4 |
| uni-app-vite-tailwindcss-v4 | v3 | h5:ssr | automated | passed | 8s | 4382MB | 3808MB | step:platform-build-uni-app-vite-tailwindcss-v4-h5-ssr | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | mp-alipay | automated | passed | 5s | 1465MB | 920MB | step:platform-build-uni-app-vite-tailwindcss-v4-mp-alipay | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | mp-baidu | automated | passed | 5s | 1430MB | 869MB | step:platform-build-uni-app-vite-tailwindcss-v4-mp-baidu | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | mp-kuaishou | automated | passed | 5s | 1483MB | 910MB | step:platform-build-uni-app-vite-tailwindcss-v4-mp-kuaishou | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | mp-lark | automated | passed | 5s | 1461MB | 901MB | step:platform-build-uni-app-vite-tailwindcss-v4-mp-lark | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | mp-qq | automated | passed | 5s | 1446MB | 880MB | step:platform-build-uni-app-vite-tailwindcss-v4-mp-qq | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | mp-toutiao | automated | passed | 5s | 1468MB | 904MB | step:platform-build-uni-app-vite-tailwindcss-v4-mp-toutiao | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | mp-weixin | automated | passed | 5s | 1532MB | 965MB | step:platform-build-uni-app-vite-tailwindcss-v4-mp-weixin | automated | passed | 2659ms | 1387ms | 2348MB | 1655MB | e2e/benchmark/e2e-watch-hmr/2026-06-19T02-09-23-629Z-uni-app-vite-tailwindcss-v4.json |
| uni-app-vite-tailwindcss-v4 | v3 | quickapp-webview | automated | passed | 5s | 1443MB | 878MB | step:platform-build-uni-app-vite-tailwindcss-v4-quickapp-webview | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | quickapp-webview-huawei | automated | passed | 5s | 1488MB | 918MB | step:platform-build-uni-app-vite-tailwindcss-v4-quickapp-webview-huawei | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
| uni-app-vite-tailwindcss-v4 | v3 | quickapp-webview-union | automated | passed | 5s | 1438MB | 872MB | step:platform-build-uni-app-vite-tailwindcss-v4-quickapp-webview-union | exempt | exempt | - | - | - | - | 该平台当前只做构建产物验证，没有登记真实运行态 HMR 命令。 |
