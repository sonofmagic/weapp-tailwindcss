# taro-vite-vue3-tailwindcss-v3 微信小程序端内存报告
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | passed | 4 | 454MB | 1156MB | 702MB | 869MB | 5 | 3s | `pnpm --filter @weapp-tailwindcss-demo/taro-vite-vue3-tailwindcss-v3 run build:weapp` |
| hmr | passed | 263 | 600MB | 1789MB | 1189MB | 883MB | 17 | 4m22s | `pnpm e2e:hot-update:demo` |
