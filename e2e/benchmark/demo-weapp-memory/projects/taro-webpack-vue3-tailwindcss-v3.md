# taro-webpack-vue3-tailwindcss-v3 微信小程序端内存报告
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | passed | 7 | 439MB | 1430MB | 991MB | 1177MB | 4 | 6s | `pnpm --filter @weapp-tailwindcss-demo/taro-webpack-vue3-tailwindcss-v3 run build:weapp` |
| hmr | passed | 429 | 616MB | 2358MB | 1742MB | 1125MB | 17 | 7m08s | `pnpm e2e:hot-update:demo` |
