# taro-webpack-react-tailwindcss-v4 微信小程序端内存报告
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | passed | 15 | 610MB | 1459MB | 849MB | 1204MB | 7 | 14s | `pnpm --filter @weapp-tailwindcss-demo/taro-webpack-react-tailwindcss-v4 run build:weapp` |
| hmr | passed | 570 | 753MB | 2058MB | 1305MB | 1160MB | 20 | 9m30s | `pnpm e2e:hot-update:demo` |
