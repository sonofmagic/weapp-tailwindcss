...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | passed | 3 | 438MB | 577MB | 139MB | 405MB | 2 | 2s | `pnpm --filter @weapp-tailwindcss-demo/gulp-tailwindcss-v3 run build` |
| hmr | passed | 51 | 921MB | 1934MB | 1013MB | 992MB | 15 | 50s | `pnpm e2e:hot-update:demo` |
