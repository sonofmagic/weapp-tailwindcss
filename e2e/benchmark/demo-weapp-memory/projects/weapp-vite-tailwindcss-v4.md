# weapp-vite-tailwindcss-v4 微信小程序端内存报告
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | passed | 4 | 182MB | 667MB | 485MB | 465MB | 3 | 3s | `pnpm --filter @weapp-tailwindcss-demo/weapp-vite-tailwindcss-v4 run build` |
| hmr | passed | 65 | 744MB | 2807MB | 2063MB | 1400MB | 13 | 1m04s | `pnpm e2e:hot-update:demo` |
