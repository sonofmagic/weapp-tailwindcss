# uni-app-vite-vue3-hbuilderx-tailwindcss-v4 微信小程序端内存报告
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | skipped | 0 | 0MB | 0MB | 0MB | 0MB | 0 | 0s | 该 watch case 被标记为 local-only，需通过指定 case 本地运行，不进入默认 demo hot-update 矩阵。 |
| hmr | skipped | 0 | 0MB | 0MB | 0MB | 0MB | 0 | 0s | 该 watch case 被标记为 local-only，需通过指定 case 本地运行，不进入默认 demo hot-update 矩阵。 |
