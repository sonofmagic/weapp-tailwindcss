# taro-vite-vue3-tailwindcss-v4 微信小程序端内存报告
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | passed | 4 | 443MB | 971MB | 528MB | 701MB | 5 | 3s | `pnpm --filter @weapp-tailwindcss-demo/taro-vite-vue3-tailwindcss-v4 run build:weapp` |
| hmr | passed | 255 | 592MB | 1998MB | 1406MB | 890MB | 18 | 4m14s | `pnpm e2e:hot-update:demo` |
