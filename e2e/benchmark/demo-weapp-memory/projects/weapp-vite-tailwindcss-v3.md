# weapp-vite-tailwindcss-v3 微信小程序端内存报告
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | passed | 6 | 182MB | 531MB | 349MB | 349MB | 2 | 5s | `pnpm --filter @weapp-tailwindcss-demo/weapp-vite-tailwindcss-v3 run build` |
| hmr | passed | 61 | 740MB | 2850MB | 2110MB | 1412MB | 14 | 1m00s | `pnpm e2e:hot-update:demo` |
