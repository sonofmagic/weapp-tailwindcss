# taro-webpack-react-tailwindcss-v3 微信小程序端内存报告
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| build | passed | 10 | 438MB | 1763MB | 1325MB | 1510MB | 4 | 9s | `pnpm --filter @weapp-tailwindcss-demo/taro-webpack-react-tailwindcss-v3 run build:weapp` |
| hmr | passed | 432 | 596MB | 2335MB | 1739MB | 1123MB | 16 | 7m11s | `pnpm e2e:hot-update:demo` |
